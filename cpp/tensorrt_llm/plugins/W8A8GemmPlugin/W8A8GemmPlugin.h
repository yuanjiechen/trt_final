 ...
 */
#ifndef TRT_W8A8_GEMM_PLUGIN_H
#define TRT_W8A8_GEMM_PLUGIN_H
...
class W8A8GemmPlugin : public IPluginV2DynamicExt
{
public:
    W8A8GemmPlugin() = delete;

    W8A8GemmPlugin(bool peChannelScaling, bool perTokenScaling, nvinfer1::DataType type);

    W8A8GemmPlugin(const void* data, size_t length);

    ~W8A8GemmPlugin() override = default;
...
class W8A8GemmPluginCreator : public IPluginCreator
{
public:
    W8A8GemmPluginCreator();
