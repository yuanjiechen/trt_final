...
class HostDeviceMem:
    ...
    def __init__(self, size: int, dtype: np.dtype):
        ...
        self._host = None#np.ctypeslib.as_array(ctypes.cast(host_mem, pointer_type), (size,))
...
def memcopy_device_to_device(dest: int, src: int, nbytes):
    cuda_call(cudart.cudaMemcpy(dest, src, nbytes, cudart.cudaMemcpyKind.cudaMemcpyDeviceToDevice))
