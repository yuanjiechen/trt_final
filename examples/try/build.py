...
from weight import load_from_hf_llama, load_from_meta_llama, load_from_meta_linear  # isort:skip
from model import test_module
MODEL_NAME = "llama"
...
def build_rank_engine(builder: Builder,
    ...
    modules = test_module()
    load_from_meta_linear(modules, args.meta_ckpt_dir)
    # Initialize Module
    ...
    with net_guard(network):
        x = modules.prepare_inputs(1, 4, 8)
        modules(x)
    # with net_guard(network):
    #     # Prepare
